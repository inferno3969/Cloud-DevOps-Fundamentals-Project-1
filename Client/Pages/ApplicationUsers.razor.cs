...
namespace CloudDevOpsProject1.Client.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<CloudDevOpsProject1.Server.Models.ApplicationUser> users;
        protected RadzenDataGrid<CloudDevOpsProject1.Server.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(CloudDevOpsProject1.Server.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(CloudDevOpsProject1.Server.Models.ApplicationUser user)
        {
            try
            {
