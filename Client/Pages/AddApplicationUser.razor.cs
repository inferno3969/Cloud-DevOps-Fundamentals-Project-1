...
namespace CloudDevOpsProject1.Client.Pages
{
    ...
    public partial class AddApplicationUser
    {
        ...
        protected CloudDevOpsProject1.Server.Models.ApplicationUser user;
        ...
        {
            user = new CloudDevOpsProject1.Server.Models.ApplicationUser();

            roles = await Security.GetRoles();
        }

        protected async Task FormSubmit(CloudDevOpsProject1.Server.Models.ApplicationUser user)
        {
            try
            {
