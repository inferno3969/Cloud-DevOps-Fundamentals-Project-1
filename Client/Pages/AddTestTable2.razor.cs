...
namespace CloudDevOpsProject1.Client.Pages
{
    public partial class AddTestTable2
    {
        ...
        {
            testTable2 = new CloudDevOpsProject1.Server.Models.DevOps_Proj_Database.TestTable2();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await DevOps_Proj_DatabaseService.CreateTestTable2(testTable2);
