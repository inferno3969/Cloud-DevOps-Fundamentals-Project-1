...
namespace CloudDevOpsProject1.Server.Controllers.DevOps_Proj_Database
{
    ...
    public partial class TestTable2SController : ODataController
    {
        ...
        public TestTable2SController(CloudDevOpsProject1.Server.Data.DevOps_Proj_DatabaseContext context)
        {
        ...
        public IEnumerable<CloudDevOpsProject1.Server.Models.DevOps_Proj_Database.TestTable2> GetTestTable2S()
        {
            var items = this.context.TestTable2S.AsQueryable<CloudDevOpsProject1.Server.Models.DevOps_Proj_Database.TestTable2>();
        ...
        partial void OnTestTable2Get(ref SingleResult<CloudDevOpsProject1.Server.Models.DevOps_Proj_Database.TestTable2> item);

        [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
        [HttpGet("/odata/DevOps_Proj_Database/TestTable2S(NateIsGay={NateIsGay})")]
        public SingleResult<CloudDevOpsProject1.Server.Models.DevOps_Proj_Database.TestTable2> GetTestTable2(string key)
        {
        ...
        [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
        public IActionResult PutTestTable2(string key, [FromBody]CloudDevOpsProject1.Server.Models.DevOps_Proj_Database.TestTable2 item)
        {
            try
            {
                if(!ModelState.IsValid)
        ...
        [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
        public IActionResult PatchTestTable2(string key, [FromBody]Delta<CloudDevOpsProject1.Server.Models.DevOps_Proj_Database.TestTable2> patch)
        {
            try
            {
                if(!ModelState.IsValid)
        ...
        [HttpPost]
        [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
        public IActionResult Post([FromBody] CloudDevOpsProject1.Server.Models.DevOps_Proj_Database.TestTable2 item)
        {
            try
            {
                if(!ModelState.IsValid)
