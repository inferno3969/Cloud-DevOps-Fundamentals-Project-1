...
namespace RadzenTest.Client.Pages
{
    public partial class TestTable2S
    {
        ...
        protected IEnumerable<RadzenTest.Server.Models.DevOps_Proj_Database.TestTable2> testTable2S;

        protected RadzenDataGrid<RadzenTest.Server.Models.DevOps_Proj_Database.TestTable2> grid0;
        protected int count;
        ...
        protected async Task EditRow(RadzenTest.Server.Models.DevOps_Proj_Database.TestTable2 args)
        {
            await DialogService.OpenAsync<EditTestTable2>("Edit TestTable2", new Dictionary<string, object> { {"NateIsGay", args.NateIsGay} });
            await grid0.Reload();
        }

        protected async Task GridDeleteButtonClick(MouseEventArgs args, RadzenTest.Server.Models.DevOps_Proj_Database.TestTable2 testTable2)
        {
            try
            {
