...
namespace RadzenTest.Client.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<RadzenTest.Server.Models.ApplicationUser> users;
        protected RadzenDataGrid<RadzenTest.Server.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(RadzenTest.Server.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(RadzenTest.Server.Models.ApplicationUser user)
        {
            try
            {
